 ...
 * v5.8: Grid Sync (Skills + Telemetry) y Vínculos de Brillo corregidos.
 */
export default function Home() {
  ...
  return (
    <TopicsProvider repositories={[]}>
      <main id="top" className="px-4 sm:px-6 md:px-16 max-w-[1800px] mx-auto min-h-screen relative z-10 flex flex-col gap-16 pt-24 sm:pt-32 pb-32">
